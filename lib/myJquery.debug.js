...
$(function () {
	...
	function myArticle () {
		var bodyWidth = $.getValues().bodyWidth,bodyHeight = $.getValues().bodyHeight,animateTime = $.getValues().animateTime;
		var datas = data_myArticle,$content = $('.content'), $myArticle = $('.box_myArticle'),moduleHeight = $myArticle.height(),moduleWidth = $myArticle.width(),$btns = $myArticle.find('div.article_menu_box'),$walls = $myArticle.find('.wall_paper')
